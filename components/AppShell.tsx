...
import { CircleDot, Coffee, Heart, Home, Menu, UserRound, X } from "lucide-react";
import { useState } from "react";
import { SITE_CONFIG } from "@/lib/config";

const nav = [{href:"/",label:"Home",icon:Home},{href:"/community",label:"이번 주",icon:Coffee},{href:"/space",label:"SPACE",icon:CircleDot},{href:"/heart",label:"마음",icon:Heart},{href:"/my",label:"MY",icon:UserRound}];
